...
/** Site settings */
define('WP_SITEURL', 'https://'. fromenv('SITEURL', getenv('SERVER_NAME')));
define('WP_HOME',  'https://'. fromenv('SITEURL', getenv('SERVER_NAME')));

/** Disable Updates, because core updates will be overwritten on container restart */
define( 'WP_AUTO_UPDATE_CORE', false );

/** Don't allow plugin/theme editing through the frontend (it wouldn't work on Docker anyway) */
...
/* If we're behind a proxy server not passing $_SERVER['HTTP_HOST'], set it to $_SERVER['HTTP_X_FORWARDED_HOST']
 * to prevent "too many redirects" error as well as WP_SITEURL & WP_HOME -related errors
 * see also https://wordpress.org/support/topic/wordpress-behind-azure-front-door-too-many-redirects/
 */
